    ...
    <div class="container grid cols-3">
        <?php foreach ($features as $f): ?>
            <div class="feature">
                ...
                <p class="muted small mt-8"><?= e((string) $f['description']) ?></p>
            </div>
        <?php endforeach; ?>
    </div>
</section>
        ...
        <?php foreach ($tiers as $t): ?>
            <div class="card" style="<?= (int) $t['is_featured'] === 1 ? 'border-color:var(--blue);box-shadow:0 0 0 2px var(--blue-050)' : '' ?>">
                <div class="card-body text-center">
                    <?php if ((int) $t['is_featured'] === 1): ?><span class="badge blue mb-8">Popular</span><?php endif; ?>
                    ...
                    <p class="small muted mb-16"><?= e((string) $t['description']) ?></p>
...
<section class="container" style="padding:8px 0 72px;max-width:560px">
    <div class="card"><div class="card-body">
        <h2 class="h2 mb-16">Get in touch</h2>
